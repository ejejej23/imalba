...
public class ApplyAdDAO {
	...
	public int dataCount() {
		...
		try {
			...
			System.out.println("dataCountApplyAdmin전체::::" + e.toString());
		} finally {
			if (rs != null) {
				try {
					rs.close();
	...
	public int dataCount(String searchKey, String searchValue) {
		...
		try {
			...
			System.out.println("dataCountAdmin검색::::" + e.toString());
		} finally {
			if (rs != null) {
				try {
					rs.close();
	...
	public List<ApplyAdDTO> listApplyA(int start, int end) {
		...
		try {
			...
			System.out.println("listApplyA관리자::::" + e.toString());
		} finally {
			if (rs != null) {
				try {
					rs.close();
	...
	public List<ApplyAdDTO> listApplyA(int start, int end, String searchKey, String searchValue) {
		...
		try {
			...
			System.out.println("listApplyA관리자검색::::" + e.toString());
		} finally {
			if (rs != null) {
				try {
					rs.close();
